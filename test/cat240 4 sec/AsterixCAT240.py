...
azimuthCount = 0
videoRecordHeader = 0
# Tempo desiderato per una rotazione completa dell'azimut (360 gradi), in secondi.
AZIMUTH_ROTATION_PERIOD_SECONDS = 4.0
...
class AsterixCAT240:
    ...
    def canvasGenerator(self, MCAST_GRP="239.0.0.1", MCAST_PORT=4433, PATTERN=1):
        ...
        # Il reset viene effettuato dopo la definizione della lista degli azimut,
        # così possiamo usare len(azimuths) invece di un valore hard-coded.
        ...
        # Regola la velocità di rotazione: len(azimuths) radiali in 4 secondi => 360°/4s.
        time.sleep(AZIMUTH_ROTATION_PERIOD_SECONDS / len(azimuths))
